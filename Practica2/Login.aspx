                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block d-flex align-items-center">
                                ...
                                <h4 style="color:#691C32" class="d-flex justify-content-center">ESIME ZACATENCO</h4>
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form runat="server">
                                        ...
                                        <div class="d-flex align-items-center mb-3 pb-1">
                                            ...
                                            <span class="h1 fw-bold mb-0">Calculadora Ancho de Banda Digital</span>
                                        </div>

                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Ingresa a tu Cuenta</h5>

                                        <div class="form-outline mb-4">
                                            <asp:TextBox ID="usuario" runat="server" CssClass="form-control form-control-lg" ></asp:TextBox>
                                            <asp:Label ID="lbusuario" runat="server" Text="Usuario o Correo electrónico" CssClass="form-label"></asp:Label>
                                        </div>

                                        <div class="form-outline mb-4">
                                             <asp:TextBox ID="contra" runat="server" CssClass="form-control form-control-lg" ></asp:TextBox>
                                            <asp:Label ID="lbcontra" runat="server" Text="Contraseña" CssClass="form-label"></asp:Label>
                                        </div>

                                        <div class="pt-1 mb-4">
                                            <asp:Button ID="btnIngresa" runat="server" Text="Ingresar" CssClass="btn btn-dark btn-lg btn-block" />
                                        </div>
                                    </form>
